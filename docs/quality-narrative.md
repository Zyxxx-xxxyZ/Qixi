# Quality narrative (maintainer reference)

> **Audience:** maintainers and quality-gate contracts.  
> **Not** the public project front page — see root [`README.md`](../README.md) for product overview.  
> This file preserves detailed verification narrative previously embedded in the root README so deterministic contracts and historical gate language stay reviewable.
